...
void Menu::draw()
{
    ...
    // Use 4-arg signature: rec, roundness, segments, color
    DrawRectangleRoundedLines(start_button, 0.3, 6, BLACK);
    DrawRectangleRoundedLines(keybindings_button, 0.3, 6, BLACK);
    DrawRectangleRoundedLines(exit_button, 0.3, 6, BLACK);
...
void Menu::draw_keybindings()
{
    ...
    // Use 4-arg signature: rec, roundness, segments, color
    DrawRectangleRoundedLines(return_button, 0.3, 6, BLACK);
    DrawRectangleRounded(keybindings_background, 0.3, 0, RAYWHITE);
    DrawRectangleRoundedLines(keybindings_background, 0.3, 6, BLACK);
